...
public class Newapp {
    ...
    private static void testEnum(Card c) {
        if(c==Card.CLUB) System.out.println("CLUB");
        else if(c==Card.DIAMOND) System.out.println("DIAMOND");
        else if(c==Card.HEART) System.out.println("HEART");
        else System.out.println("SPADE");
    }
    
    private static void testClass(int c) {
        if(c==CardConstants.CLUB) System.out.println("CLUB");
        else if(c==CardConstants.DIAMOND) System.out.println("DIAMOND");
        else if(c==CardConstants.HEART) System.out.println("HEART");
        else System.out.println("SPADE");
    }
}
